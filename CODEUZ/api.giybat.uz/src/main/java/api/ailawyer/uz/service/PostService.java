...
import api.ailawyer.uz.repository.CustomPostRepository;
import api.ailawyer.uz.repository.PostRepository;
...
public class PostService {
    ...
    public PostDTO create(PostCreateDTO dto){
        if (!SpringSecurityUtil.hazRole(ProfileRole.ROLE_LAWYER)
            ...
            throw new RuntimeException("Faqat yurist yoki admin post yaratishi mumkin");
        }
